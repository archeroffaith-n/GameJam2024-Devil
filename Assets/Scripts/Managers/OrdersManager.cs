...
public class OrdersManager : MonoBehaviour
{
    public class Order 
    {
        ...
        public SummonLevelManager.LevelAndSpell levelAndSpell;

        public Order(int id, int phoneLine, OrderType orderType, bool isCallCorrect, int? orderValue_opt, SummonLevelManager.LevelAndSpell levelAndSpell)
        {
            ...
            this.levelAndSpell = levelAndSpell;
    ...
    private SummonLevelManager summonLevelManager;
    ...
    void Start()
    {
        ...
        summonLevelManager = gameObject.GetComponent<SummonLevelManager>();
        ...
        if (acceptOrders) {
            if (GetBusyLines() < numPhoneLines) {
                ...
                if (waitingTimeLeft < 0) {
                    ...
                    bool isCorrect = RandomIsCallCorrect();
                    orderList.Add(new Order(nextId++, phoneLine, RandomOrderType(), isCorrect, null, summonLevelManager.GenerateLevelAndSpell(isCorrect)));
